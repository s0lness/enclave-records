...
bash scripts/dev/tap.sh 5001 "Cut the master"
wait $CUT_PID
...
snap 5001 "03-sas-a"
snap 5002 "04-sas-b"
bash scripts/dev/tap.sh 5001 "Words match"
bash scripts/dev/tap.sh 5002 "Words match"
wait $PAIR_PID
...
bash scripts/dev/tap.sh 5001 "Press this copy"
sleep 2
snap 5002 "06-press-accept-b"
bash scripts/dev/tap.sh 5002 "Receive it"
wait $PRESS_PID
